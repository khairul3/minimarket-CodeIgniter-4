						...
						<div class="col-md-6">
							<div class="card shadow">
								...
								<div class="card-body">
									...
									<input type="text" value="<?= session()->login['nama'] ?>" readonly class="form-control mt-2 mb-2">
									<strong>Username : </strong><br>
									<input type="text" value="<?= session()->login['username'] ?>" readonly class="form-control mt-2 mb-2">
									<strong>Role : </strong><br>
									<input type="text" value="<?= session()->login['role'] ?>" readonly class="form-control mt-2 mb-2">
									<strong>Jam Login : </strong><br>
									<input type="text" value="<?= session()->login['jam_masuk'] ?>" readonly class="form-control mt-2">
								</div>
							</div>
						</div>
					</div>
